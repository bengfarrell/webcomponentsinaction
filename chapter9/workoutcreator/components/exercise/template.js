        ...
        return `<div id="info">
                    ...
                    <div id="customize">
                        <label class="${exercise.time?'visible':'hidden'}">
                            <input type="number" max="999" style="width:45px;" value="${Number(exercise.time)}"> seconds
                        </label>
                        ...
                        <label class="${exercise.sets?'visible':'hidden'}">x 
                            <input type="number" max="9" style="width:30px;" value="${Number(exercise.sets)}"> set(s)
                        </label>
                    </div>
