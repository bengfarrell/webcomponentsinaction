...
if (window.jsfeat) {
  console.log("wrapper: window.jsfeat exists; exporting it.")
} else {
  function wrap () {
    /**
...
const result = window.jsfeat
if (!result) throw Error("wrapper failed, file: node_modules/jsfeat/build/jsfeat.js name: jsfeat")
console.log('wraplib node_modules/jsfeat/build/jsfeat.js jsfeat', typeof window.jsfeat)
